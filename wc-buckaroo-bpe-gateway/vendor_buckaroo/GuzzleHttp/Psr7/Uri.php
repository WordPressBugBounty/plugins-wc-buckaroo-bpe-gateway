...
use BuckarooDeps\GuzzleHttp\Psr7\Exception\MalformedUriException;
...
class Uri implements UriInterface, \JsonSerializable
{
     ...
     * `BuckarooDeps\Psr\Http\Message\UriInterface::__toString`.
     *
     ...
     *
     * `BuckarooDeps\Psr\Http\Message\UriInterface::getPort` may return null or the standard port. This method can be used
