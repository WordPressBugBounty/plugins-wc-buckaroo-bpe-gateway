...
namespace BuckarooDeps\Ramsey\Uuid\Math;

use BuckarooDeps\Brick\Math\BigDecimal;
use BuckarooDeps\Brick\Math\BigInteger;
use BuckarooDeps\Brick\Math\Exception\MathException;
use BuckarooDeps\Brick\Math\RoundingMode as BrickMathRounding;
use BuckarooDeps\Ramsey\Uuid\Exception\InvalidArgumentException;
use BuckarooDeps\Ramsey\Uuid\Type\Decimal;
use BuckarooDeps\Ramsey\Uuid\Type\Hexadecimal;
use BuckarooDeps\Ramsey\Uuid\Type\Integer as IntegerObject;
use BuckarooDeps\Ramsey\Uuid\Type\NumberInterface;
