...
namespace BuckarooDeps\Monolog\Attribute;

/**
 * A reusable attribute to help configure a class or a method as a processor.
 * 
 * Using it offers no guarantee: it needs to be leveraged by a BuckarooDeps\Monolog third-party consumer.
 * 
 * Using it with the BuckarooDeps\Monolog library only has no effect at all: processors should still be turned into a callable if
