...
use BuckarooDeps\Monolog\Formatter\MongoDBFormatter;
 ...
 * Usage example:
 *
 *   $log = new \BuckarooDeps\Monolog\Logger('application');
 *   $client = new \MongoDB\Client('mongodb://localhost:27017');
 *   $mongodb = new \BuckarooDeps\Monolog\Handler\MongoDBHandler($client, 'logs', 'prod');
