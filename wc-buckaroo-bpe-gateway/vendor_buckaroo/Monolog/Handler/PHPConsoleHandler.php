...
/*
 * This file is part of the BuckarooDeps\Monolog package.
 *
...
namespace BuckarooDeps\Monolog\Handler;

use BuckarooDeps\Monolog\Formatter\LineFormatter;
use BuckarooDeps\Monolog\Formatter\FormatterInterface;
use BuckarooDeps\Monolog\Logger;
use BuckarooDeps\Monolog\Utils;
use PhpConsole\Connector;
use PhpConsole\Handler as VendorPhpConsoleHandler;
use PhpConsole\Helper;

/**
 * BuckarooDeps\Monolog handler for Google Chrome extension "PHP Console"
 *
 ...
 *
 *      $logger = new \BuckarooDeps\Monolog\Logger('all', array(new \BuckarooDeps\Monolog\Handler\PHPConsoleHandler()));
 *      \BuckarooDeps\Monolog\ErrorHandler::register($logger);
 *      echo $undefinedVar;
 ...
 *
 * @phpstan-import-type Record from \BuckarooDeps\Monolog\Logger
 * @deprecated Since 2.8.0 and 3.2.0, PHPConsole is abandoned and thus we will drop this handler in BuckarooDeps\Monolog 4
 */
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    private $options = [
        ...
        'classesPartialsTraceIgnore' => ['BuckarooDeps\Monolog\\'], // array Hide calls of classes started with...
    ...
    /**
     * @param  array<string, mixed> $options   See \BuckarooDeps\Monolog\Handler\PHPConsoleHandler::$options for more details
