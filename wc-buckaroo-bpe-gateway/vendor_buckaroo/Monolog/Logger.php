...
namespace BuckarooDeps\Monolog;

use DateTimeZone;
use BuckarooDeps\Monolog\Handler\HandlerInterface;
use BuckarooDeps\Psr\Log\LoggerInterface;
use BuckarooDeps\Psr\Log\InvalidArgumentException;
use BuckarooDeps\Psr\Log\LogLevel;
use Throwable;
use Stringable;

/**
 * BuckarooDeps\Monolog log channel
 *
...
class Logger implements LoggerInterface, ResettableInterface
{
    ...
    /**
     * BuckarooDeps\Monolog API version
     *
    ...
    /**
     * Mapping between levels numbers defined in RFC 5424 and BuckarooDeps\Monolog ones
     *
     ...
     * there is no performance penalty and BuckarooDeps\Monolog 2 enabled microseconds
     ...
     * Adds a log record.
     *
     * @param  int               $level    The logging level (a BuckarooDeps\Monolog or RFC 5424 level)
     ...
     *
     * @throws \BuckarooDeps\Psr\Log\InvalidArgumentException If level is not defined
     *
     * @phpstan-param  Level     $level
    ...
    /**
     * Converts PSR-3 levels to BuckarooDeps\Monolog ones if necessary
     *
